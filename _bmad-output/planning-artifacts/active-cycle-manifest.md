...
| Sprint Change Proposal le plus recent | `_bmad-output/planning-artifacts/sprint-change-proposal-2026-06-07.md` |
...
Apres le correct-course du `2026-06-07` (`sprint-change-proposal-2026-06-07.md`) et l'integration de l'audit `homebridge-homekit-vs-ha-delta-2026-06-07.md`, la prochaine etape attendue est l'execution de `pe-epic-10`, en commencant par la story `10.0` (`10-0-prefixe-de-gel-du-perimetre-homebridge-ha-vise.md`). Cette story doit figer la matrice canonique Homebridge -> Jeedom -> HA -> statut moteur avant toute ouverture technique nouvelle (`climate`, `alarm_control_panel`, composites metier).

## 10. Resume ultra court a copier dans les prompts

Cycle actif = **Moteur de projection explicable**. Sources de verite actives = `product-brief-jeedom2ha-2026-04-09.md`, `prd.md`, `architecture-projection-engine.md`, `architecture-delta-review-prd-final.md`, `epics-projection-engine.md`, `implementation-readiness-report-2026-04-10.md`, `sprint-status.yaml`, `backlog-icebox.md`, `ha-projection-reference.md` (extrait de `docs/jeedom_homebridge_homeassistant_optionB_reference.xlsx` — source-of-truth pour les contraintes HA et les types Jeedom), `sprint-change-proposal-2026-06-07.md` (dernier correct-course : ouverture de `pe-epic-10` comme vague Homebridge -> HA minimale utile), `homebridge-homekit-vs-ha-delta-2026-06-07.md` (source de priorisation du delta utile), puis `10-0-prefixe-de-gel-du-perimetre-homebridge-ha-vise.md` comme premiere story executable. Les artefacts `V1.1 Pilotable` sont du contexte secondaire uniquement. Aucun agent ne doit deviner la source de verite.
