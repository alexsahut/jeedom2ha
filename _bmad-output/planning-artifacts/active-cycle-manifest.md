...
| Sprint Change Proposal le plus recent | `_bmad-output/planning-artifacts/sprint-change-proposal-2026-06-21-realign-11-3.md` |
| Contexte historique Homebridge -> HA (`pe-epic-10` clos) | `_bmad-output/planning-artifacts/homebridge-homekit-vs-ha-delta-2026-06-07.md` |
...
Apres le correct-course du `2026-06-21` (`sprint-change-proposal-2026-06-21-realign-11-3.md`), la prochaine etape attendue est `code-review` sur la Story `11.3` (`11-3-iq-ev-pilotage-priorisation-solaire.md`). La story ne doit pas passer `done` avant code-review et gate terrain eq583/eq628. Ensuite, si la priorite energie reste le chauffe-eau, preparer `create-story` pour `11.2` (chauffe-eau eq554).

## 10. Resume ultra court a copier dans les prompts

Cycle actif = **Moteur de projection explicable**. Sources de verite actives = `product-brief-jeedom2ha-2026-04-09.md`, `prd.md`, `architecture-projection-engine.md`, `architecture-delta-review-prd-final.md`, `epics-projection-engine.md`, `implementation-readiness-report-2026-04-10.md`, `sprint-status.yaml`, `backlog-icebox.md`, `ha-projection-reference.md` (extrait de `docs/jeedom_homebridge_homeassistant_optionB_reference.xlsx` — source-of-truth pour les contraintes HA et les types Jeedom), `sprint-change-proposal-2026-06-21-realign-11-3.md` (dernier correct-course : 11.3 en review, artefacts réalignés), `homebridge-homekit-vs-ha-delta-2026-06-07.md` (contexte historique de priorisation du delta utile), puis `11-3-iq-ev-pilotage-priorisation-solaire.md` comme story en review. Les artefacts `V1.1 Pilotable` sont du contexte secondaire uniquement. Aucun agent ne doit deviner la source de verite.
