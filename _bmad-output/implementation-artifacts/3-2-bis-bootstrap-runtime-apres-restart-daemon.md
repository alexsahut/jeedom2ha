...
- Les tests reels 3.2b-A/B/C et le preflight box reelle restent a executer; la story demeure `in-progress` tant que cette preuve terrain n'est pas capturee.
...
- 2026-03-15: Story maintenue en `in-progress` en attente des tests reels 3.2b-A/B/C et du preflight box reelle; aucun glissement Epic 5 ni assouplissement du gating runtime.
